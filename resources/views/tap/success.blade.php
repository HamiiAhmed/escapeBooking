    ...
    <div class="container">
        <div class="success-card">
            ...
            <div class="success-body">
                <h5 class="text-center mb-4" style="color:#800000;">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value fw-bold" style="color:#800000;">SAR {{ $totalAmount }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Payment Method</span>
                    <span class="detail-value">Tap</span>
                </div>

                <hr class="my-4">

                <div class="text-center">
                    <p class="text-muted">We've sent a confirmation email to
